...
Shader "SkyboxShader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_TexCoord12 = v.texcoord.xy * _Noise_1_Tiling;
			float2 panner8 = ( 1.0 * _Time.y * _Noise_1_Panner + uv_TexCoord12);
			float2 uv_TexCoord17 = v.texcoord.xy * _Noise_2_Tiling;
			float2 panner9 = ( 1.0 * _Time.y * _Noise_2_Panner + uv_TexCoord17);
			float2 uv_TexCoord19 = v.texcoord.xy * _Noise_3_Tiling;
		...
		{
			float2 uv_TexCoord12 = i.uv_texcoord * _Noise_1_Tiling;
			float2 panner8 = ( 1.0 * _Time.y * _Noise_1_Panner + uv_TexCoord12);
			float2 uv_TexCoord17 = i.uv_texcoord * _Noise_2_Tiling;
			float2 panner9 = ( 1.0 * _Time.y * _Noise_2_Panner + uv_TexCoord17);
			float2 uv_TexCoord19 = i.uv_texcoord * _Noise_3_Tiling;
			float2 panner10 = ( 1.0 * _Time.y * _Noise_3_Panner + uv_TexCoord19);
...
/*ASEBEGIN
Version=16900
2567;190;1906;1011;1026.742;150.3657;1.278653;True;False
Node;AmplifyShaderEditor.Vector2Node;15;-2281.399,-129.9;Float;False;Property;_Noise_1_Tiling;Noise_1_Tiling;4;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;16;-2287.557,95.80868;Float;False;Property;_Noise_2_Tiling;Noise_2_Tiling;5;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;20;-1995.485,-7.597031;Float;False;Property;_Noise_1_Panner;Noise_1_Panner;7;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;21;-2001.643,218.1116;Float;False;Property;_Noise_2_Panner;Noise_2_Panner;8;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;18;-2286.257,338.9085;Float;False;Property;_Noise_3_Tiling;Noise_3_Tiling;6;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-2073.458,102.4087;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;9;-1788.557,97.80846;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-2073.457,345.5085;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;22;-2000.343,461.2115;Float;False;Property;_Noise_3_Panner;Noise_3_Panner;9;0;Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.PannerNode;10;-1789.858,340.9086;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;28;-630.9066,93.90881;Float;False;Property;_Noise_2_Color;Noise_2_Color;11;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;26;-631.5568,-141.3912;Float;False;Property;_Noise_1_Color;Noise_1_Color;10;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-132.9636,628.3343;Float;False;Property;_VertexOffset;VertexOffset;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;85;-887.2555,662.2079;Float;True;Property;_OpacityMask;OpacityMask;3;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
ASEEND*/
//CHKSM=065F637810A3AC3B1169645BE4D78B9CBA1B6DF1